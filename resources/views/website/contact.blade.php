            ...
            <div class="container">
                <div class="row get_contact_inner">
                    <div class="col-md-6">
                        ...
                        <form class="contact_us_form row m0" action="https://designarc.biz/demos/hilltown/theme/contact_process.php" method="post" id="contactForm" novalidate="novalidate">
